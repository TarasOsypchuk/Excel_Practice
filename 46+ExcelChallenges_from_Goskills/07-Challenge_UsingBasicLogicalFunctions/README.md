...
![Excel Challenge 7 Final](./7-Challenge_img/Final-file-1.png)
![Excel Challenge 7 Final](./7-Challenge_img/Final-file-2.png)

You can review and download the completed workbook containing the expandable dropdown and dynamic row lookup logic here:

👉 [Download excel-challenge-7-FINAL.xlsx](./7-Challenge_CreateAnExpandableDropdownList/excel-challenge-7-FINAL.xlsx)